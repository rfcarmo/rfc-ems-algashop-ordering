...
public class ShoppingCart implements AggregateRoot<ShoppingCartId> {
    ...
    public static ShoppingCart startShopping(CustomerId customerId) {
        return new ShoppingCart(new ShoppingCartId(), customerId, Money.ZERO, Quantity.ZERO, OffsetDateTime.now(), new HashSet<>(), null);
    }
    ...
    public void addItem(Product product, Quantity quantity) {
        ...
        searchItemByProduct(product.productId())
    ...
    public void refreshItem(Product product) {
        ShoppingCartItem shoppingCartItem = this.findItem(product.productId());
